...
export default function Sidebar() {
  ...
  const isActive = (path: string) => {
    return pathname === path ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-white';
  };
      ...
      <nav className="flex-1 py-4">
        <ul className="space-y-1 px-3">
          <li>
            <Link 
              href="/dashboard" 
              className={`flex items-center gap-3 px-4 py-3 rounded-md transition-colors ${isActive('/dashboard')}`}
            >
          ...
          <li>
            <Link 
              href="/map" 
              className={`flex items-center gap-3 px-4 py-3 rounded-md transition-colors ${isActive('/map')}`}
            >
              <div className="text-green-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
          ...
          <li>
            <Link 
              href="/dustbins" 
              className={`flex items-center gap-3 px-4 py-3 rounded-md transition-colors ${isActive('/dustbins')}`}
            >
              <div className="text-green-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
